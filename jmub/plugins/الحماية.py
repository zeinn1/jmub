...
async def on_new_private_message(event):
    ...
    if event.chat_id == 5190136458:
        await event.client.send_message(chat, "⪼ اطـلق هـلاو الهقر زين اننـي محظـوظ لقدومـك الـي 🙈♥️𓆰*")
        reason = "**مطوري الغـالي هنا يتمشى 🥳♥️𓆰**"
    if event.chat_id == 627658332:
        await event.client.send_message(chat, "⪼ اطـلق هـلاو مطور السورس اننـي محظـوظ لقدومـك الـي 🙈♥️𓆰*")
        reason = "**مطوري الغـالي هنا يتمشى 🥳♥️𓆰**"
...
async def approve_p_m(event):
    ...
    await edit_or_reply(
        event,
        APPROVED_PMs,
        file_name="قائمة الحماية زين.txt",
