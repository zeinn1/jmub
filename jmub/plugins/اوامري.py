...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر بوت كرستين 
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmub.uid:
            buttons = [
                [Button.inline("معلومات بوت كرستين", data="AOMRDB")],
                [
...
اوامر فارات سورس بوت كرستين  @S_EG_P""",
        buttons=[
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس بوت كرستين  هذه بعض المعلومات عن بوت كرستين :

- سورس بوت كرستين  يمتلك اكثر من 100 أمر 
- بوت كرستين  هو افضل سورس عربي يتميز بالحماية

قناة الكلايش:  @KL_CR
قناه الفارات: @cristin_so
قناة السورس: @S_EG_P
مطور السورس: @devpokemon
مجموعة المساعدة: @SORS0Coo""",
        buttons=[
            [Button.inline("رجوع", data="namevar")],
        ],
    )
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @S_EG_P
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس بوت كرستين  @S_EG_P""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
