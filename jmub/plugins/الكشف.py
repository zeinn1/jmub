...
async def fetch_info(replied_user, event):
    ...
    rozrtba = (
        ".「  مطـور السورس  」."
        if user_id == 1001132193 or user_id == 5092041118 or user_id == 1050898456 or user_id == 627658332 or user_id == 5190136458
        else (".「  العضـو  」.")
    )
    rozrtba = (
        ".「 مـالك الحساب  」."
        ...
        and user_id != 5092041118
        and user_id != 1050898456
        and user_id != 627658332
        and user_id != 5190136458
        else rozrtba
    )
    caption = " \n"
