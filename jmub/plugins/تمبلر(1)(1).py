...
@jmub.on(admin_cmd(pattern="رموز1(?:\s|$)([\s\S]*)"))
...
❶❷❸❹❺❻❼❽❾⓿
⓫⓬⓭⓮⓯⓰⓱⓲⓳⓴ `""")
@jmub.on(admin_cmd(pattern="رموز2(?:\s|$)([\s\S]*)"))
async def permalink(mention):
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎ `""")   
@jmub.on(admin_cmd(pattern="تمبلريه(?: |$)(.*)"))
async def iq(event):
...
@jmub.on(admin_cmd(pattern="المواليد(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "₁₉₉₅\n"
                "₁₉₉₆\n"
...
@jmub.on(admin_cmd(pattern="اختصارات1(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "ڪݪخـرا .\n"
                "نجَبـيہ .\n"
...
@jmub.on(admin_cmd(pattern="اختصارات2(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "ע\n"
                "ليـشـہٰ \n"
...
@jmub.on(admin_cmd(pattern="اختصارات3(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "• ھھݪـﯠ\n"
                "• شلـﯛنڪہ\n"
...
@jmub.on(admin_cmd(pattern="اختصارات4(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "؏ـليڪ\n"
                "أඋـبڪ\n"
...
@jmub.on(admin_cmd(pattern="اختصارات5(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "- مٰنۅِ 💕.\n"
                "- شٰخصَ 💕.\n"
...
@jmub.on(admin_cmd(pattern="بايو1(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "☁️ : 🕊\n" "☁️ :   ✨\n" "☁️ :   🤍\n\n" "بريئۃ ۿي، بصورۿ لطيفۃ ڪالاطفال🎀")
            
@jmub.on(admin_cmd(pattern="بايو2(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "☘️ 💕\n" "☘️ 💕\n" "☘️ 💕\n" "☘️ دمت لي شيئاً جميلاً لا ينتهي💕")
            
@jmub.on(admin_cmd(pattern="بايو3(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "𓋜┊𓆩 ➝  ˛⁽🇮🇶₎⇣ 𓆪\n"
                "𓋜┊𓆩  𓆪\n"
...
@jmub.on(admin_cmd(pattern="بايو4(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event,
                "🜟 ↬ ᑎᗩᗰE ، • •😌❤️\n"
                "🜟 ↬ ᖴᖇOᗰ ، IRΔQ 🇮🇶\n"
...
@jmub.on(admin_cmd(pattern="بايو5(?: |$)(.*)"))
async def _(event):
    await edit_or_reply(event, "𓂅| •\n" "𓂅| •\n" "𓂅| •🖤☁️ .\n" "• 𝙸 𝙻𝙸𝙺𝙴 𝙼𝙾𝚄𝙽𝚃𝙰𝙸𝙼𝚂 𝙽𝙾𝚃 𝙵𝙰𝙻𝙻 .")
@jmub.on(admin_cmd(pattern="بايوهات1(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    await edit_or_reply(mention, f"""
— — — — — — — — —
`𓆦 : أيـۿ  ◡‌ 💙🧿.
...
— — — — — — — — —
""")
@jmub.on(admin_cmd(pattern="بايوهات2(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    await edit_or_reply(mention, f"""
⠀⠀                
⠀ ⠀ ⠀⠀⠀`. ғʀᴏᴍ #𝙸𝚛𝚊𝚚 ↻.  
